...
from schemas import (
    ...
    EmailVerificationRequest, PasswordResetRequest, PasswordResetConfirm, VerifyEmailToken
)
...
async def refresh_token(
    ...
    """
    access_token = AuthService.create_access_token(
        data={"sub": str(current_user.id), "role": current_user.role, "username": current_user.username}
    )
