...
async def change_password(
    ...
    if len(new_password) < 6:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail="新密码长度至少6个字符"
        )
...
async def test_tiku_config(
    ...
    if not provider:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, detail="未指定题库提供商"
        )
    ...
    try:
        ...
        if provider == "AI":
            ...
            config_dict = {
                ...
                "siliconflow_model": tiku_config.siliconflow_model
                or "deepseek-ai/DeepSeek-R1",
                "siliconflow_endpoint": tiku_config.siliconflow_endpoint
            ...
            config_dict = {
                ...
                "deepseek_endpoint": tiku_config.deepseek_endpoint
