...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports2) {
    ...
    (function() {
      ...
      var React48 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState27 = React48.useState, useEffect28 = React48.useEffect, useLayoutEffect3 = React48.useLayoutEffect, useDebugValue2 = React48.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_zh_cn = __commonJS({
  "node_modules/dayjs/locale/zh-cn.js"(exports2, module2) {
    !function(e2, _2) {
      "object" == typeof exports2 && "undefined" != typeof module2 ? module2.exports = _2(require_dayjs_min()) : "function" == typeof define && define.amd ? define(["dayjs"], _2) : (e2 = "undefined" != typeof globalThis ? globalThis : e2 || self).dayjs_locale_zh_cn = _2(e2.dayjs);
    }(exports2, function(e2) {
      "use strict";
      function _2(e3) {
        return e3 && "object" == typeof e3 && "default" in e3 ? e3 : { default: e3 };
      }
      var t = _2(e2), d = { name: "zh-cn", weekdays: "星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"), weekdaysShort: "周日_周一_周二_周三_周四_周五_周六".split("_"), weekdaysMin: "日_一_二_三_四_五_六".split("_"), months: "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"), monthsShort: "1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"), ordinal: function(e3, _3) {
  ...
  "node_modules/@babel/runtime/helpers/interopRequireWildcard.js"(exports2, module2) {
    ...
    function _interopRequireWildcard(e2, t) {
      ...
      return (module2.exports = _interopRequireWildcard = function _interopRequireWildcard2(e3, t2) {
        ...
        for (var _t in e3) "default" !== _t && {}.hasOwnProperty.call(e3, _t) && ((i = (o3 = Object.defineProperty) && Object.getOwnPropertyDescriptor(e3, _t)) && (i.get || i.set) ? o3(f, _t, i) : f[_t] = e3[_t]);
        return f;
...
var o2 = (e2, r) => it(e2, "name", { value: r, configurable: true });
var pe2 = o2(({ action: e2, resource: r, onMutationSuccess: t, onMutationError: s, autoSave: n2, submitOnEnter: a = false, warnWhenUnsavedChanges: p, redirect: i, successNotification: l, errorNotification: u, meta: y, queryMeta: d, mutationMeta: f, liveMode: m, liveParams: c, mutationMode: T, dataProviderName: g, onLiveEvent: b, invalidates: S, undoableTimeout: P, queryOptions: C, createMutationOptions: x, updateMutationOptions: w, id: h, overtimeOptions: D, optimisticUpdateMap: j, defaultFormValues: L, disableServerSideValidation: B = false } = {}) => {
  var re, ne;
  let { options: N } = fe(), Y = (N == null ? void 0 : N.disableServerSideValidation) || B, K = q(), [H] = form_default.useForm(), Q = useForm({ form: H, defaultFormValues: L }), { form: O } = Q, q2 = FT({ onMutationSuccess: t || void 0, onMutationError: async ($, ie, He) => {
    if (Y) {
      s == null || s($, ie, He);
      return;
    }
    let ue2 = [], at = O.getFieldsValue();
    ue2 = Object.keys(rr(at)).map((Oe) => ({ name: Io(Oe), errors: void 0 })), O.setFields(ue2);
    let xr = $ == null ? void 0 : $.errors;
    for (let Oe in xr) {
      let ae = xr[Oe], Se = [];
      Array.isArray(ae) && (Se = ae), typeof ae == "string" && (Se = [ae]), typeof ae == "boolean" && ae && (Se = ["Field is not valid."]), typeof ae == "object" && "key" in ae && (Se = [K(ae.key, ae.message)]), ue2.push({ name: Io(Oe), errors: Se });
    }
    O.setFields([...ue2]), s == null || s($, ie, He);
  }, redirect: i, action: e2, resource: r, successNotification: l, errorNotification: u, meta: y, queryMeta: d, mutationMeta: f, liveMode: m, liveParams: c, mutationMode: T, dataProviderName: g, onLiveEvent: b, invalidates: S, undoableTimeout: P, queryOptions: C, createMutationOptions: x, updateMutationOptions: w, id: h, overtimeOptions: D, optimisticUpdateMap: j, autoSave: n2 }), { formLoading: v, onFinish: z, query: F, id: U, onFinishAutoSave: A } = q2, { warnWhenUnsavedChanges: W, setWarnWhen: E } = Dt(), k = p ?? W;
  import_react76.default.useEffect(() => {
    O.resetFields();
  }, [(re = F == null ? void 0 : F.data) == null ? void 0 : re.data, U]);
  let R = o2(($) => {
    a && $.key === "Enter" && O.submit();
  }, "onKeyUp"), G2 = o2(($, ie) => {
    if ($ && k && E(true), n2 != null && n2.enabled) {
      E(false);
      let He = (n2 == null ? void 0 : n2.onFinish) ?? ((ue2) => ue2);
      return A(He(ie)).catch((ue2) => ue2);
    }
    return $;
  }, "onValuesChange"), J = { disabled: v, onClick: () => {
    O.submit();
  } };
  return { form: Q.form, formProps: { ...Q.formProps, onFinish: ($) => z($).catch((ie) => ie), onKeyUp: R, onValuesChange: G2, initialValues: (ne = F == null ? void 0 : F.data) == null ? void 0 : ne.data }, saveButtonProps: J, defaultFormValuesLoading: Q.defaultFormValuesLoading, ...q2, onFinish: async ($) => await z($ ?? Q.form.getFieldsValue(true)) };
}, "useForm");
var Cr = o2(({ modalProps: e2 = {} } = {}) => {
  let { show: r, close: t, visible: s } = ph({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (n2) => {
    var a;
    (a = e2.onCancel) == null || a.call(e2, n2), t();
  }, open: s, visible: s }, show: r, close: t };
}, "useModal");
var Sr2 = o2(({ syncWithLocation: e2, defaultVisible: r = false, autoSubmitClose: t = true, autoResetForm: s = true, autoResetFormWhenClose: n2 = true, autoSave: a, invalidates: p, ...i }) => {
  var k;
  let [l, u] = import_react77.default.useState(false), y = Ce(), { resource: d, action: f, identifier: m } = G({ resource: i.resource }), c = ue(), T = pe(), g = $e(), b = i.action ?? f ?? "", S = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), P = typeof e2 == "object" && "key" in e2 ? e2.key : d && b && e2 ? `modal-${m}-${b}` : void 0, C = pe2({ meta: { ...P ? { [P]: void 0 } : {}, ...i.meta }, autoSave: a, invalidates: p, ...i }), { form: x, formProps: w, id: h, setId: D, formLoading: j, onFinish: L, autoSaveProps: B } = C, N = q(), { warnWhen: Y, setWarnWhen: K } = Dt(), { show: H, close: Q, modalProps: O } = Cr({ modalProps: { open: r } }), q2 = O.open || false, v = { modalProps: O, form: x, formLoading: j, formProps: w, formResult: void 0, formValues: x.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: L, close: Q, open: O.open || false, show: H };
  import_react77.default.useEffect(() => {
    var R, G2, J, re;
    if (l === false && P) {
      let ne = (G2 = (R = c == null ? void 0 : c.params) == null ? void 0 : R[P]) == null ? void 0 : G2.open;
      if (typeof ne == "boolean" ? ne && H() : typeof ne == "string" && ne === "true" && H(), S) {
        let $ = (re = (J = c == null ? void 0 : c.params) == null ? void 0 : J[P]) == null ? void 0 : re.id;
        $ && (D == null || D($));
      }
      u(true);
    }
  }, [P, c, S, D]), import_react77.default.useEffect(() => {
    var R;
    l === true && (q2 && P ? T({ query: { [P]: { ...(R = c == null ? void 0 : c.params) == null ? void 0 : R[P], open: true, ...S && h && { id: h } } }, options: { keepQuery: true }, type: "replace" }) : P && !q2 && T({ query: { [P]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [h, q2, H, P, S]);
  let z = { disabled: j, loading: j, onClick: () => {
    x.submit();
  } }, F = (0, import_react77.useCallback)(() => {
    if (B.status === "success" && (a != null && a.invalidateOnClose) && y({ id: h, invalidates: p || ["list", "many", "detail"], dataProviderName: i.dataProviderName, resource: m }), Y) if (window.confirm(N("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) K(false);
    else return;
    D == null || D(void 0), v.close(), n2 && x.resetFields();
  }, [Y, B.status]), U = (0, import_react77.useCallback)((R) => {
    typeof R < "u" && (D == null || D(R)), (!(b === "edit" || b === "clone") || (typeof R < "u" || typeof h < "u")) && v.show();
  }, [h]), { visible: A, ...W } = O, E = { open: A, ...W };
  return { ...C, ...v, show: U, close: F, open: q2, formProps: { ...w, ...C.formProps, onValuesChange: w == null ? void 0 : w.onValuesChange, onKeyUp: w == null ? void 0 : w.onKeyUp, onFinish: async (R) => {
    await L(R), t && Q(), s && x.resetFields();
  } }, modalProps: { ...E, width: "1000px", okButtonProps: z, title: N(`${m}.titles.${i.action}`, `${g(`${i.action} ${((k = d == null ? void 0 : d.meta) == null ? void 0 : k.label) ?? m}`, "singular")}`), okText: N("buttons.save", "Save"), cancelText: N("buttons.cancel", "Cancel"), onCancel: F, forceRender: true }, formLoading: j };
}, "useModalForm");
var Er = o2(({ drawerProps: e2 = {} } = {}) => {
  let { show: r, close: t, visible: s } = ph({ defaultVisible: e2.open });
  return { drawerProps: { ...e2, onClose: (n2) => {
    var a;
    (a = e2.onClose) == null || a.call(e2, n2), t();
  }, open: s }, show: r, close: t };
}, "useDrawer");
var vr = o2(({ syncWithLocation: e2, defaultVisible: r = false, autoSubmitClose: t = true, autoResetForm: s = true, autoSave: n2, invalidates: a, ...p }) => {
  let i = Ce(), [l, u] = import_react78.default.useState(false), { show: y, close: d, drawerProps: f } = Er({ drawerProps: { open: r } }), m = f.open || false, { resource: c, action: T, identifier: g } = G({ resource: p.resource }), b = ue(), S = pe(), P = p.action ?? T ?? "", C = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), x = typeof e2 == "object" && "key" in e2 ? e2.key : c && P && e2 ? `drawer-${(c == null ? void 0 : c.identifier) ?? (c == null ? void 0 : c.name)}-${P}` : void 0, w = pe2({ meta: { ...x ? { [x]: void 0 } : {}, ...p.meta }, autoSave: n2, invalidates: a, ...p }), { form: h, formProps: D, formLoading: j, id: L, setId: B, onFinish: N, autoSaveProps: Y } = w;
  import_react78.default.useEffect(() => {
    var F, U, A, W;
    if (l === false && x) {
      let E = (U = (F = b == null ? void 0 : b.params) == null ? void 0 : F[x]) == null ? void 0 : U.open;
      if (typeof E == "boolean" ? E ? y() : d() : typeof E == "string" && E === "true" && y(), C) {
        let k = (W = (A = b == null ? void 0 : b.params) == null ? void 0 : A[x]) == null ? void 0 : W.id;
        k && (B == null || B(k));
      }
      u(true);
    }
  }, [x, b, C, B, l]), import_react78.default.useEffect(() => {
    var F;
    l === true && (m && x ? S({ query: { [x]: { ...(F = b == null ? void 0 : b.params) == null ? void 0 : F[x], open: true, ...C && L && { id: L } } }, options: { keepQuery: true }, type: "replace" }) : x && !m && S({ query: { [x]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [L, m, y, d, x, C, l]);
  let K = q(), { warnWhen: H, setWarnWhen: Q } = Dt(), O = { disabled: j, onClick: () => {
    h.submit();
  }, loading: j }, q2 = { recordItemId: L, onSuccess: () => {
    B == null || B(void 0), d();
  } }, v = (0, import_react78.useCallback)(() => {
    if (Y.status === "success" && (n2 != null && n2.invalidateOnClose) && i({ id: L, invalidates: a || ["list", "many", "detail"], dataProviderName: p.dataProviderName, resource: g }), H) if (window.confirm(K("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) Q(false);
    else return;
    d(), B == null || B(void 0);
  }, [H]), z = (0, import_react78.useCallback)((F) => {
    typeof F < "u" && (B == null || B(F)), (!(P === "edit" || P === "clone") || (typeof F < "u" || typeof L < "u")) && y();
  }, [L]);
  return { ...w, show: z, close: v, formProps: { form: h, ...w.formProps, onValuesChange: D == null ? void 0 : D.onValuesChange, onKeyUp: D == null ? void 0 : D.onKeyUp, onFinish: async (F) => {
    await N(F), t && d(), s && h.resetFields();
  } }, drawerProps: { ...f, width: "500px", onClose: v, open: m, forceRender: true }, saveButtonProps: O, deleteButtonProps: q2, formLoading: j };
}, "useDrawerForm");
var Rr = o2((e2 = {}) => {
  let r = pe2({ ...e2 }), { form: t, formProps: s } = r, n2 = useStepsForm({ isBackValidate: false, form: t, submit: (a) => {
    var p;
    (p = s == null ? void 0 : s.onFinish) == null || p.call(s, a);
  }, ...e2 });
  return { ...r, ...n2, formLoading: r.formLoading, formProps: { ...n2.formProps, ...r.formProps, onValuesChange: s == null ? void 0 : s.onValuesChange, onKeyUp: s == null ? void 0 : s.onKeyUp }, saveButtonProps: { ...r.saveButtonProps, onClick: () => n2.submit() } };
}, "useStepsForm");
var Vt = o2((e2, r) => {
  let t = es(e2, r);
  if (t) return `${t}end`;
}, "getDefaultSortOrder");
var It = o2((e2, r, t = "eq") => ts(e2, r, t), "getDefaultFilter");
var $e2 = o2((e2) => {
  let r = [];
  if (Array.isArray(e2)) e2.sort((t, s) => {
    var n2, a;
    return (((n2 = t.column) == null ? void 0 : n2.sorter).multiple ?? 0) < (((a = s.column) == null ? void 0 : a.sorter).multiple ?? 0) ? -1 : 0;
  }).map((t) => {
    if (t.field && t.order) {
      let s = Array.isArray(t.field) ? t.field.join(".") : `${t.field}`;
      r.push({ field: `${t.columnKey ?? s}`, order: t.order.replace("end", "") });
    }
  });
  else if (e2.field && e2.order) {
    let t = Array.isArray(e2.field) ? e2.field.join(".") : `${e2.field}`;
    r.push({ field: `${e2.columnKey ?? t}`, order: e2.order.replace("end", "") });
  }
  return r;
}, "mapAntdSorterToCrudSorting");
var Ye = o2((e2, r, t) => {
  let s = [], n2 = (t ?? []).reduce((a, p) => {
    let i = p.key || p.field;
    return { ...a, [i]: p };
  }, {});
  return Object.keys(e2).map((a) => {
    var l, u;
    let p = e2[a], i = ((l = r.filter((y) => y.operator !== "or").find((y) => y.field === a)) == null ? void 0 : l.operator) || ((u = n2[a]) == null ? void 0 : u.operator);
    i !== "or" && i !== "and" && s.push({ field: a, operator: i ?? (Array.isArray(p) ? "in" : "eq"), value: p });
  }), s;
}, "mapAntdFilterToCrudFilter");
var me = o2(({ to: e2, element: r }) => {
  let t = Je();
  return import_react80.default.createElement(t, { to: e2, replace: false, onClick: (s) => {
    s.preventDefault();
  } }, r);
}, "PaginationLink");
var Xe = o2(({ onSearch: e2, pagination: r, filters: t, sorters: s, syncWithLocation: n2, resource: a, successNotification: p, errorNotification: i, queryOptions: l, liveMode: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m } = {}) => {
  let { tableQuery: c, currentPage: T, setCurrentPage: g, pageSize: b, setPageSize: S, filters: P, setFilters: C, sorters: x, setSorters: w, createLinkForSyncWithLocation: h, pageCount: D, overtime: j, result: L } = xP({ pagination: r, filters: t, sorters: s, syncWithLocation: n2, resource: a, successNotification: p, errorNotification: i, queryOptions: l, liveMode: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m }), { syncWithLocation: B } = br(), N = n2 ?? B, Y = grid_default.useBreakpoint(), [K] = form_default.useForm(), H = useForm({ form: K }), Q = Xo(u), O = (r == null ? void 0 : r.mode) !== "off", q2 = t == null ? void 0 : t.initial, { data: v, isFetched: z, isLoading: F } = c;
  import_react79.default.useEffect(() => {
    if (N) {
      let E = H.form.getFieldsValue(), k = Object.keys(E).reduce((R, G2) => {
        let J = P.find((re) => "field" in re && re.field === G2);
        return J && (R[G2] = J == null ? void 0 : J.value), R;
      }, {});
      H.form.setFieldsValue(k);
    }
  }, [N]);
  let U = o2((E, k, R) => {
    ...
    O && (g == null || g(E.current || 1), S == null || S(E.pageSize || 10));
  }, "onChange"), A = o2(async (E) => {
    if (e2) {
      let k = await e2(E);
      C(k), O && (g == null || g(1));
    }
  }, "onFinish"), W = o2(() => O ? { itemRender: (E, k, R) => {
    var J;
    let G2 = h({ pagination: { pageSize: b, currentPage: E }, sorters: x, filters: P });
    if (k === "page") return (0, import_react79.createElement)(me, { to: G2, element: `${E}` });
    if (k === "next" || k === "prev") return (0, import_react79.createElement)(me, { to: G2, element: R });
    if (k === "jump-next" || k === "jump-prev") {
      let re = (J = R == null ? void 0 : R.props) == null ? void 0 : J.children;
      return (0, import_react79.createElement)(me, { to: G2, element: import_react79.Children.count(re) > 1 ? (0, import_react79.createElement)(import_react79.Fragment, {}, re) : re });
    }
    return R;
  }, pageSize: b, current: T, simple: !Y.sm, position: Y.sm ? ["bottomRight"] : ["bottomCenter"], total: v == null ? void 0 : v.total } : false, "antdPagination");
  return { searchFormProps: { ...H.formProps, onFinish: A }, tableProps: { dataSource: v == null ? void 0 : v.data, loading: Q === "auto" ? F : !z, onChange: U, pagination: W(), scroll: { x: true } }, tableQuery: c, sorters: x, filters: P, setSorters: w, setFilters: C, currentPage: T, setCurrentPage: g, pageSize: b, setPageSize: S, pageCount: D, createLinkForSyncWithLocation: h, overtime: j, result: L };
}, "useTable");
var Gt = o2(({ autoSubmitClose: e2 = true, ...r } = {}) => {
  let t = Xe({ ...r, successNotification: void 0, errorNotification: void 0 }), s = pe2({ ...r, action: "edit", redirect: false }), { id: n2, setId: a, saveButtonProps: p } = s, i = { onClick: () => {
    a(void 0);
  } }, l = o2((y) => ({ onClick: () => a(y) }), "editButtonProps"), u = o2((y) => y === n2, "isEditing");
  return { ...t, ...s, formProps: { ...s.formProps, onFinish: async (y) => {
    try {
      let d = await s.onFinish(y);
      return e2 && a(void 0), d;
    } catch (d) {
      return d;
    }
  } }, saveButtonProps: p, cancelButtonProps: i, editButtonProps: l, isEditing: u };
}, "useEditableTable");
var il = o2((e2) => {
  let { query: r, defaultValueQuery: t, onSearch: s, options: n2 } = cP(e2);
  return { selectProps: { options: n2, onSearch: s, loading: t.query.isFetching, showSearch: true, filterOption: false }, query: r, defaultValueQuery: t.query };
}, "useSelect");
var ul = o2(({ resource: e2, sorters: r, filters: t, optionLabel: s, optionValue: n2, queryOptions: a, pagination: p, liveMode: i, defaultValue: l, selectedOptionsOrder: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m, ...c }) => {
  let { query: T, options: g } = cP({ resource: e2, sorters: r, filters: t, optionLabel: s, optionValue: n2, queryOptions: a, pagination: p, liveMode: i, defaultValue: l, selectedOptionsOrder: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m, ...c });
  return { checkboxGroupProps: { options: g, defaultValue: l }, query: T };
}, "useCheckboxGroup");
var yl = o2(({ resource: e2, sorters: r, filters: t, optionLabel: s, optionValue: n2, queryOptions: a, pagination: p, liveMode: i, defaultValue: l, selectedOptionsOrder: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m, ...c }) => {
  let { query: T, options: g } = cP({ resource: e2, sorters: r, filters: t, optionLabel: s, optionValue: n2, queryOptions: a, pagination: p, liveMode: i, defaultValue: l, selectedOptionsOrder: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m, ...c });
  return { radioGroupProps: { options: g, defaultValue: l }, query: T };
}, "useRadioGroup");
var xl2 = o2(({ resource: e2, mapData: r = o2((l) => l, "mapData"), paparseOptions: t, batchSize: s = Number.MAX_SAFE_INTEGER, onFinish: n2, meta: a, dataProviderName: p, onProgress: i } = {}) => {
  let l = q(), { resource: u } = G({ resource: e2 }), { mutationResult: y, isLoading: d, handleChange: f } = ah({ resource: (u == null ? void 0 : u.identifier) ?? (u == null ? void 0 : u.name), mapData: r, paparseOptions: t, batchSize: s, meta: a, dataProviderName: p, onFinish: n2, onProgress: i ?? (({ totalAmount: m, processedAmount: c }) => {
    if (m > 0 && c > 0) {
      let T = import_react81.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react81.default.createElement(progress_default, { type: "circle", percent: Math.floor(c / m * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react81.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, l("notifications.importProgress", { processed: c, total: m }, `Importing: ${c}/${m}`)));
      notification_default.open({ description: T, message: null, key: `${u}-import`, duration: 0 }), c >= m, c === m && setTimeout(() => {
        notification_default.destroy(`${u}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: f, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: d }, mutationResult: y, isLoading: d };
}, "useImport");
var io = o2(({ resource: e2, pagination: r, filters: t, sorters: s, onSearch: n2, queryOptions: a, syncWithLocation: p, successNotification: i, errorNotification: l, liveMode: u, onLiveEvent: y, liveParams: d, meta: f, dataProviderName: m } = {}) => {
  let { sorters: c, filters: T, currentPage: g, pageSize: b, pageCount: S, setFilters: P, setCurrentPage: C, setPageSize: x, setSorters: w, createLinkForSyncWithLocation: h, tableQuery: D, overtime: j, result: L } = xP({ resource: e2, pagination: r, filters: t, sorters: s, queryOptions: a, successNotification: i, errorNotification: l, liveMode: u, onLiveEvent: y, liveParams: d, meta: f, syncWithLocation: p, dataProviderName: m }), B = (r == null ? void 0 : r.mode) !== "off", N = grid_default.useBreakpoint(), Y = Xo(u), [K] = form_default.useForm(), { data: H, isFetched: Q, isLoading: O } = D, q2 = o2((F, U) => {
    B && (C(F), x(U || 10));
  }, "onChange"), v = o2(async (F) => {
    if (n2) {
      let U = await n2(F);
      return B && (C == null || C(1)), P(U);
    }
  }, "onFinish"), z = o2(() => B ? { itemRender: (F, U, A) => {
    var E;
    let W = h({ pagination: { pageSize: b, currentPage: F }, sorters: c, filters: T });
    if (U === "page") return (0, import_react82.createElement)(me, { to: W, element: `${F}` });
    if (U === "next" || U === "prev") return (0, import_react82.createElement)(me, { to: W, element: A });
    if (U === "jump-next" || U === "jump-prev") {
      let k = (E = A == null ? void 0 : A.props) == null ? void 0 : E.children;
      return (0, import_react82.createElement)(me, { to: W, element: import_react82.Children.count(k) > 1 ? (0, import_react82.createElement)(import_react82.Fragment, {}, k) : k });
    }
    return A;
  }, pageSize: b, current: g, simple: !N.sm, total: H == null ? void 0 : H.total, onChange: q2 } : false, "antdPagination");
  return { searchFormProps: { form: K, onFinish: v }, listProps: { dataSource: H == null ? void 0 : H.data, loading: Y === "auto" ? O : !Q, pagination: z() }, query: D, filters: T, setFilters: P, sorters: c, setSorters: w, currentPage: g, setCurrentPage: C, pageSize: b, setPageSize: x, pageCount: S, createLinkForSyncWithLocation: h, overtime: j, result: L };
}, "useSimpleList");
var Vl = o2(() => {
  let [e2, r] = (0, import_react83.useState)(false), t = (0, import_react83.useCallback)((s) => {
    mo(s.fileList).includes(true) ? r(true) : r(false);
  }, []);
  return (0, import_react83.useMemo)(() => ({ isLoading: e2, onChange: t }), [e2]);
}, "useFileUploadState");
var mo = o2((e2) => e2.map((r) => {
  switch (r.status) {
    case "uploading":
      return true;
    default:
...
var Ne = import_react85.default.createContext({ siderCollapsed: false, mobileSiderOpen: false, setSiderCollapsed: () => {
}, setMobileSiderOpen: () => {
} });
var Je2 = o2(({ children: e2, initialSiderCollapsed: r, onSiderCollapsed: t }) => {
  let [s, n2] = (0, import_react85.useState)(r ?? false), [a, p] = (0, import_react85.useState)(false), i = o2((l) => {
    n2(l), t && t(l);
  }, "setSiderCollapsed");
  return import_react85.default.createElement(Ne.Provider, { value: { siderCollapsed: s, mobileSiderOpen: a, setSiderCollapsed: i, setMobileSiderOpen: p } }, e2);
}, "ThemedLayoutContextProvider");
var Ur2 = o2(() => {
  let { mobileSiderOpen: e2, siderCollapsed: r, setMobileSiderOpen: t, setSiderCollapsed: s } = (0, import_react84.useContext)(Ne);
  return { mobileSiderOpen: e2, siderCollapsed: r, setMobileSiderOpen: t, setSiderCollapsed: s };
}, "useThemedLayoutContext");
var Vr = o2(({ message: e2, cancelMutation: r, undoableTimeout: t }) => import_react87.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react87.default.createElement(progress_default, { type: "circle", percent: (t ?? 0) * 20, format: (s) => s && s / 20, size: 50, strokeColor: "#1890ff", status: "normal" }), import_react87.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react87.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: r, disabled: t === 0, icon: import_react87.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
var ed = o2(() => {
  let { notification: e2 } = app_default.useApp(), r = "open" in e2 ? e2 : notification_default;
  return { open: ({ key: s, message: n2, description: a, type: p, cancelMutation: i, undoableTimeout: l }) => {
    p === "progress" ? r.open({ key: s, description: import_react86.default.createElement(Vr, { notificationKey: s, message: n2, cancelMutation: () => {
      i == null || i(), r.destroy(s ?? "");
    }, undoableTimeout: l }), message: null, duration: 0, closeIcon: import_react86.default.createElement(import_react86.default.Fragment, null) }) : r.open({ key: s, description: n2, message: a ?? null, type: p });
  }, close: (s) => r.destroy(s) };
}, "useNotificationProvider");
var Ir2 = { borderStartStartRadius: 0, borderEndStartRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var rr2 = o2(({ Title: e2, render: r, meta: t, fixed: s, activeItemDisabled: n2 = false, siderItemsAreCollapsed: a = true }) => {
  var q2;
  let { token: p } = theme_default.useToken(), { siderCollapsed: i, setSiderCollapsed: l, mobileSiderOpen: u, setMobileSiderOpen: y } = Ur2(), d = kr(), f = (q2 = (0, import_react89.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : q2.direction, m = Je(), { warnWhen: c, setWarnWhen: T } = Dt(), g = q(), { menuItems: b, selectedKey: S, defaultOpenKeys: P } = Zi({ meta: t }), C = grid_default.useBreakpoint(), { mutate: x } = Ur(), w = typeof C.lg > "u" ? false : !C.lg, h = e2 ?? oe, D = o2((v, z) => v.map((F) => {
    let { key: U, name: A, children: W, meta: E, list: k } = F, R = E == null ? void 0 : E.parent, G2 = (F == null ? void 0 : F.label) ?? (E == null ? void 0 : E.label) ?? A, J = E == null ? void 0 : E.icon, re = k;
    if (W.length > 0) return import_react89.default.createElement(Au, { key: F.key, resource: A, action: "list", params: { resource: F } }, import_react89.default.createElement(menu_default.SubMenu, { key: F.key, icon: J ?? import_react89.default.createElement(UnorderedListOutlined_default, null), title: G2 }, D(W, z)));
    let ne = U === z, $ = !(R !== void 0 && W.length === 0), ie = n2 && ne ? { pointerEvents: "none" } : {};
    return import_react89.default.createElement(Au, { key: F.key, resource: A, action: "list", params: { resource: F } }, import_react89.default.createElement(menu_default.Item, { key: F.key, icon: J ?? ($ && import_react89.default.createElement(UnorderedListOutlined_default, null)), style: ie }, import_react89.default.createElement(m, { to: re ?? "", style: ie }, G2), !i && ne && import_react89.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), j = o2(() => {
    c ? window.confirm(g("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (T(false), x()) : x();
  }, "handleLogout"), L = d && import_react89.default.createElement(menu_default.Item, { key: "logout", onClick: () => j(), icon: import_react89.default.createElement(LogoutOutlined_default, null) }, g("buttons.logout", "Logout")), B = (() => a ? [] : b.map(({ key: v }) => v))(), N = D(b, S), Y = o2(() => r ? r({ items: N, logout: L, collapsed: i }) : [...N, L].filter(Boolean), "renderSider"), K = o2(() => import_react89.default.createElement(menu_default, { selectedKeys: S ? [S] : [], defaultOpenKeys: [...P, ...B], mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, Y()), "renderMenu"), H = o2(() => import_react89.default.createElement(import_react89.default.Fragment, null, import_react89.default.createElement(drawer_default, { open: u, onClose: () => y(false), placement: f === "rtl" ? "right" : "left", closable: false, width: 200, styles: { body: { padding: 0 } }, maskClosable: true }, import_react89.default.createElement(layout_default, null, import_react89.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: p.colorBgContainer, borderRight: `1px solid ${p.colorBgElevated}` } }, import_react89.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: p.colorBgElevated } }, import_react89.default.createElement(h, { collapsed: false })), K()))), import_react89.default.createElement(button_default, { style: Ir2, size: "large", onClick: () => y(true), icon: import_react89.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (w) return H();
  let Q = { backgroundColor: p.colorBgContainer, borderRight: `1px solid ${p.colorBgElevated}` };
  s && (Q.position = "fixed", Q.top = 0, Q.height = "100vh", Q.zIndex = 999);
  let O = o2(() => {
    let v = { style: { color: p.colorPrimary } };
    return import_react89.default.createElement(i ? f === "rtl" ? LeftOutlined_default : RightOutlined_default : f === "rtl" ? RightOutlined_default : LeftOutlined_default, { ...v });
  }, "renderClosingIcons");
  return import_react89.default.createElement(import_react89.default.Fragment, null, s && import_react89.default.createElement("div", { style: { width: i ? "80px" : "200px", transition: "all 0.2s" } }), import_react89.default.createElement(layout_default.Sider, { style: Q, collapsible: true, collapsed: i, onCollapse: (v, z) => {
    z === "clickTrigger" && l(v);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react89.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: p.colorBgElevated } }, O()) }, import_react89.default.createElement("div", { style: { width: i ? "80px" : "200px", padding: i ? "0" : "0 16px", display: "flex", justifyContent: i ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: p.colorBgElevated, fontSize: "14px" } }, import_react89.default.createElement(h, { collapsed: i })), K()));
}, "ThemedSider");
var tr = o2(({ sticky: e2 }) => {
  let { token: r } = theme_default.useToken(), { data: t } = Mr();
  if (!(t && (t.name || t.avatar))) return null;
  let n2 = { backgroundColor: r.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" };
  return e2 && (n2.position = "sticky", n2.top = 0, n2.zIndex = 1), import_react90.default.createElement(layout_default.Header, { style: n2 }, import_react90.default.createElement(space_default, null, import_react90.default.createElement(space_default, { size: "middle" }, (t == null ? void 0 : t.name) && import_react90.default.createElement(typography_default.Text, { strong: true }, t.name), (t == null ? void 0 : t.avatar) && import_react90.default.createElement(avatar_default, { src: t == null ? void 0 : t.avatar, alt: t == null ? void 0 : t.name }))));
}, "ThemedHeader");
var Mo = o2(({ children: e2, Header: r, Sider: t, Title: s, Footer: n2, OffLayoutArea: a, initialSiderCollapsed: p, onSiderCollapsed: i }) => {
  let l = grid_default.useBreakpoint(), u = t ?? rr2, y = r ?? tr, d = typeof l.sm > "u" ? true : l.sm, f = !!u({ Title: s });
  return import_react88.default.createElement(Je2, { initialSiderCollapsed: p, onSiderCollapsed: i }, import_react88.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: f }, import_react88.default.createElement(u, { Title: s }), import_react88.default.createElement(layout_default, null, import_react88.default.createElement(y, null), import_react88.default.createElement(layout_default.Content, null, import_react88.default.createElement("div", { style: { minHeight: 360, padding: d ? 24 : 12 } }, e2), a && import_react88.default.createElement(a, null)), n2 && import_react88.default.createElement(n2, null))));
}, "ThemedLayout");
var oe = o2(({ collapsed: e2, icon: r, text: t, wrapperStyles: s }) => {
  let { title: { icon: n2, text: a } = {} } = yt(), p = typeof r > "u" ? n2 : r, i = typeof t > "u" ? a : t, { token: l } = theme_default.useToken(), u = Je();
  return import_react91.default.createElement(u, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react91.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react91.default.createElement("div", { style: { height: "24px", width: "24px", color: l.colorPrimary } }, p), !e2 && import_react91.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, i)));
}, "ThemedTitle");
var nr = o2(({ resource: e2, hideText: r = false, accessControl: t, meta: s, children: n2, onClick: a, ...p }) => {
  let { hidden: i, disabled: l, label: u, title: y, LinkComponent: d, to: f } = TR({ resource: e2, meta: s, accessControl: t }), m = l || p.disabled;
  return i || p.hidden ? null : import_react92.default.createElement(d, { to: f, replace: false, onClick: (T) => {
    if (m) {
      T.preventDefault();
      return;
    }
    a && (T.preventDefault(), a(T));
  } }, import_react92.default.createElement(button_default, { icon: import_react92.default.createElement(PlusSquareOutlined_default, null), disabled: m, title: y, className: n.CreateButton, type: "primary", ...p }, !r && (n2 ?? u)));
}, "CreateButton");
var ir = o2(({ resource: e2, recordItemId: r, hideText: t = false, accessControl: s, meta: n2, children: a, onClick: p, ...i }) => {
  let { to: l, label: u, title: y, hidden: d, disabled: f, LinkComponent: m } = yR({ resource: e2, id: r, meta: n2, accessControl: s }), c = f || i.disabled;
  return d || i.hidden ? null : import_react93.default.createElement(m, { to: l, replace: false, onClick: (g) => {
    if (c) {
      g.preventDefault();
      return;
    }
    p && (g.preventDefault(), p(g));
  } }, import_react93.default.createElement(button_default, { icon: import_react93.default.createElement(EditOutlined_default, null), disabled: c, title: y, className: n.EditButton, ...i }, !t && (a ?? u)));
}, "EditButton");
var ve = o2(({ resource: e2, recordItemId: r, onSuccess: t, mutationMode: s, children: n2, successNotification: a, errorNotification: p, hideText: i = false, accessControl: l, meta: u, dataProviderName: y, confirmTitle: d, confirmOkText: f, confirmCancelText: m, invalidates: c, ...T }) => {
  let { title: g, label: b, hidden: S, disabled: P, loading: C, confirmTitle: x, confirmOkLabel: w, cancelLabel: h, onConfirm: D } = nu({ resource: e2, id: r, dataProviderName: y, invalidates: c, meta: u, onSuccess: t, mutationMode: s, errorNotification: p, successNotification: a, accessControl: l }), j = P || T.disabled;
  return S || T.hidden ? null : import_react94.default.createElement(popconfirm_default, { key: "delete", okText: f ?? w, cancelText: m ?? h, okType: "danger", title: d ?? x, okButtonProps: { disabled: C }, onConfirm: D, disabled: j }, import_react94.default.createElement(button_default, { danger: true, loading: C, icon: import_react94.default.createElement(DeleteOutlined_default, null), title: g, disabled: j, className: n.DeleteButton, ...T }, !i && (n2 ?? b)));
}, "DeleteButton");
var Re = o2(({ resource: e2, recordItemId: r, hideText: t = false, dataProviderName: s, children: n2, ...a }) => {
  let { onClick: p, label: i, loading: l } = au({ resource: e2, id: r, dataProviderName: s });
  return import_react95.default.createElement(button_default, { onClick: p, icon: import_react95.default.createElement(RedoOutlined_default, { spin: l }), className: n.RefreshButton, ...a }, !t && (n2 ?? i));
}, "RefreshButton");
var Ts = o2(({ resource: e2, recordItemId: r, hideText: t = false, accessControl: s, meta: n2, children: a, onClick: p, ...i }) => {
  let { to: l, label: u, title: y, hidden: d, disabled: f, LinkComponent: m } = fR({ resource: e2, id: r, accessControl: s, meta: n2 }), c = f || i.disabled;
  return d || i.hidden ? null : import_react96.default.createElement(m, { to: l, replace: false, onClick: (g) => {
    if (c) {
      g.preventDefault();
      return;
    }
    p && (g.preventDefault(), p(g));
  } }, import_react96.default.createElement(button_default, { disabled: c, icon: import_react96.default.createElement(EyeOutlined_default, null), title: y, className: n.ShowButton, ...i }, !t && (a ?? u)));
}, "ShowButton");
var we = o2(({ resource: e2, hideText: r = false, accessControl: t, meta: s, children: n2, onClick: a, ...p }) => {
  let { to: i, label: l, title: u, hidden: y, disabled: d, LinkComponent: f } = xR({ resource: e2, meta: s, accessControl: t }), m = d || p.disabled;
  return y || p.hidden ? null : import_react97.default.createElement(f, { to: i, replace: false, onClick: (T) => {
    if (m) {
      T.preventDefault();
      return;
    }
    a && (T.preventDefault(), a(T));
  } }, import_react97.default.createElement(button_default, { icon: import_react97.default.createElement(BarsOutlined_default, null), disabled: m, title: u, className: n.ListButton, ...p }, !r && (n2 ?? l)));
}, "ListButton");
var Ds = o2(({ hideText: e2 = false, children: r, ...t }) => {
  let { label: s } = PR();
  return import_react98.default.createElement(button_default, { type: "default", icon: import_react98.default.createElement(ExportOutlined_default, null), className: n.ExportButton, ...t }, !e2 && (r ?? s));
}, "ExportButton");
var ke = o2(({ hideText: e2 = false, children: r, ...t }) => {
  let { label: s } = hR();
  return import_react99.default.createElement(button_default, { type: "primary", icon: import_react99.default.createElement(SaveOutlined_default, null), className: n.SaveButton, ...t }, !e2 && (r ?? s));
}, "SaveButton");
var Ms = o2(({ resource: e2, recordItemId: r, hideText: t = false, accessControl: s, meta: n2, children: a, onClick: p, ...i }) => {
  let { to: l, LinkComponent: u, label: y, disabled: d, hidden: f, title: m } = gR({ id: r, resource: e2, accessControl: s, meta: n2 }), c = d || i.disabled;
  return f || i.hidden ? null : import_react100.default.createElement(u, { to: l, replace: false, onClick: (g) => {
    if (c) {
      g.preventDefault();
      return;
    }
    p && (g.preventDefault(), p(g));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(PlusSquareOutlined_default, null), disabled: c, title: m, className: n.CloneButton, ...i }, !t && (a ?? y)));
}, "CloneButton");
var Ks = o2(({ uploadProps: e2, buttonProps: r, hideText: t = false, children: s, loading: n2, ...a }) => {
  let { label: p } = CR();
  return import_react101.default.createElement(upload_default, { ...e2 }, import_react101.default.createElement(button_default, { icon: import_react101.default.createElement(ImportOutlined_default, null), className: n.ImportButton, loading: n2, ...r, ...a }, !t && (s ?? p)));
}, "ImportButton");
var _s = o2(({ canCreate: e2, title: r, children: t, createButtonProps: s, resource: n2, wrapperProps: a, contentProps: p, headerProps: i, breadcrumb: l, headerButtonProps: u, headerButtons: y }) => {
  var C;
  let d = q(), { options: { breadcrumb: f } = {} } = fe(), m = $e(), { resource: c, identifier: T } = G({ resource: n2 }), g = e2 ?? (!!(c != null && c.create) || !!s), b = typeof l > "u" ? f : l, S = g ? { size: "middle", resource: T, ...s } : void 0, P = g ? import_react102.default.createElement(nr, { ...S }) : null;
  return import_react102.default.createElement("div", { ...a ?? {} }, import_react102.default.createElement(ye, { title: r ?? d(`${T}.titles.list`, m(((C = c == null ? void 0 : c.meta) == null ? void 0 : C.label) ?? T, "plural")), extra: y ? import_react102.default.createElement(space_default, { wrap: true, ...u }, typeof y == "function" ? y({ defaultButtons: P, createButtonProps: S }) : y) : P, breadcrumb: typeof b < "u" ? import_react102.default.createElement(import_react102.default.Fragment, null, b) : import_react102.default.createElement(fe2, null), ...i ?? {} }, import_react102.default.createElement("div", { ...p ?? {} }, t)));
}, "List");
var nn = o2(({ title: e2, saveButtonProps: r, children: t, resource: s, isLoading: n2 = false, breadcrumb: a, wrapperProps: p, headerProps: i, contentProps: l, headerButtonProps: u, headerButtons: y, footerButtonProps: d, footerButtons: f, goBack: m }) => {
  var h;
  let c = q(), { options: { breadcrumb: T } = {} } = fe(), g = Mi(), b = $e(), { resource: S, identifier: P } = G({ resource: s }), C = typeof a > "u" ? T : a, x = { ...n2 ? { disabled: true } : {}, ...r, htmlType: "submit" }, w = import_react103.default.createElement(import_react103.default.Fragment, null, import_react103.default.createElement(ke, { ...x }));
  return import_react103.default.createElement("div", { ...p ?? {} }, import_react103.default.createElement(ye, { backIcon: m, onBack: g, title: e2 ?? c(`${P}.titles.create`, `Create ${b(((h = S == null ? void 0 : S.meta) == null ? void 0 : h.label) ?? P, "singular")}`), breadcrumb: typeof C < "u" ? import_react103.default.createElement(import_react103.default.Fragment, null, C) : import_react103.default.createElement(fe2, null), extra: import_react103.default.createElement(space_default, { wrap: true, ...u ?? {} }, y ? typeof y == "function" ? y({ defaultButtons: null }) : y : null), ...i ?? {} }, import_react103.default.createElement(spin_default, { spinning: n2 }, import_react103.default.createElement(card_default, { variant: "borderless", actions: [import_react103.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...d ?? {} }, f ? typeof f == "function" ? f({ defaultButtons: w, saveButtonProps: x }) : f : w)], ...l ?? {} }, t))));
}, "Create");
var gn = o2(({ title: e2, saveButtonProps: r, mutationMode: t, recordItemId: s, children: n2, deleteButtonProps: a, canDelete: p, resource: i, isLoading: l = false, dataProviderName: u, breadcrumb: y, wrapperProps: d, headerProps: f, contentProps: m, headerButtonProps: c, headerButtons: T, footerButtonProps: g, footerButtons: b, goBack: S, autoSaveProps: P }) => {
  var k, R;
  let C = q(), { options: { breadcrumb: x } = {} } = fe(), { mutationMode: w } = Ie(), h = t ?? w, D = Mi(), j = pe(), L = $e(), { resource: B, action: N, id: Y, identifier: K } = G({ resource: i }), H = Ui({ resource: B, action: "list" }), Q = s ?? Y, O = typeof y > "u" ? x : y, q2 = (B == null ? void 0 : B.list) && !s, v = p ?? (((k = B == null ? void 0 : B.meta) == null ? void 0 : k.canDelete) || a), z = q2 ? { ...l ? { disabled: true } : {}, resource: K } : void 0, F = { ...l ? { disabled: true } : {}, resource: K, recordItemId: Q, dataProviderName: u }, U = v ? { ...l ? { disabled: true } : {}, resource: K, mutationMode: h, onSuccess: () => {
    j({ to: H });
  }, recordItemId: Q, dataProviderName: u, ...a } : void 0, A = { ...l ? { disabled: true } : {}, ...r }, W = import_react104.default.createElement(import_react104.default.Fragment, null, P && import_react104.default.createElement(Gr, { ...P }), q2 && import_react104.default.createElement(we, { ...z }), import_react104.default.createElement(Re, { ...F })), E = import_react104.default.createElement(import_react104.default.Fragment, null, v && import_react104.default.createElement(ve, { ...U }), import_react104.default.createElement(ke, { ...A }));
  return import_react104.default.createElement("div", { ...d ?? {} }, import_react104.default.createElement(ye, { backIcon: S, onBack: N !== "list" && typeof N < "u" ? D : void 0, title: e2 ?? C(`${K}.titles.edit`, `Edit ${L(((R = B == null ? void 0 : B.meta) == null ? void 0 : R.label) ?? K, "singular")}`), extra: import_react104.default.createElement(space_default, { wrap: true, ...c ?? {} }, T ? typeof T == "function" ? T({ defaultButtons: W, listButtonProps: z, refreshButtonProps: F }) : T : W), breadcrumb: typeof O < "u" ? import_react104.default.createElement(import_react104.default.Fragment, null, O) : import_react104.default.createElement(fe2, null), ...f ?? {} }, import_react104.default.createElement(spin_default, { spinning: l }, import_react104.default.createElement(card_default, { variant: "borderless", actions: [import_react104.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...g ?? {} }, b ? typeof b == "function" ? b({ defaultButtons: E, deleteButtonProps: U, saveButtonProps: A }) : b : E)], ...m ?? {} }, n2))));
}, "Edit");
var Dn = o2(({ title: e2, canEdit: r, canDelete: t, deleteButtonProps: s, isLoading: n2 = false, children: a, resource: p, recordItemId: i, dataProviderName: l, breadcrumb: u, contentProps: y, headerProps: d, wrapperProps: f, headerButtons: m, footerButtons: c, footerButtonProps: T, headerButtonProps: g, goBack: b }) => {
  var U, A;
  let S = q(), { options: { breadcrumb: P } = {} } = fe(), C = Mi(), x = pe(), w = $e(), { resource: h, action: D, id: j, identifier: L } = G({ resource: p }), B = Ui({ resource: h, action: "list" }), N = i ?? j, Y = typeof u > "u" ? P : u, K = (h == null ? void 0 : h.list) && !i, H = t ?? (((U = h == null ? void 0 : h.meta) == null ? void 0 : U.canDelete) || s), Q = r ?? !!(h != null && h.edit), O = K ? { resource: L } : void 0, q2 = Q ? { ...n2 ? { disabled: true } : {}, type: "primary", resource: L, recordItemId: N } : void 0, v = H ? { ...n2 ? { disabled: true } : {}, resource: L, recordItemId: N, onSuccess: () => {
    x({ to: B });
  }, dataProviderName: l, ...s } : void 0, z = { ...n2 ? { disabled: true } : {}, resource: L, recordItemId: N, dataProviderName: l }, F = import_react105.default.createElement(import_react105.default.Fragment, null, K && import_react105.default.createElement(we, { ...O }), Q && import_react105.default.createElement(ir, { ...q2 }), H && import_react105.default.createElement(ve, { ...v }), import_react105.default.createElement(Re, { ...z }));
  return import_react105.default.createElement("div", { ...f ?? {} }, import_react105.default.createElement(ye, { backIcon: b, onBack: D !== "list" && typeof D < "u" ? C : void 0, title: e2 ?? S(`${L}.titles.show`, `Show ${w(((A = h == null ? void 0 : h.meta) == null ? void 0 : A.label) ?? L, "singular")}`), extra: import_react105.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...g ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: F, deleteButtonProps: v, editButtonProps: q2, listButtonProps: O, refreshButtonProps: z }) : m : F), breadcrumb: typeof Y < "u" ? import_react105.default.createElement(import_react105.default.Fragment, null, Y) : import_react105.default.createElement(fe2, null), ...d ?? {} }, import_react105.default.createElement(spin_default, { spinning: n2 }, import_react105.default.createElement(card_default, { variant: "borderless", actions: c ? [import_react105.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...T }, typeof c == "function" ? c({ defaultButtons: null }) : c)] : void 0, ...y ?? {} }, a))));
}, "Show");
var wn = o2(({ value: e2, ...r }) => import_react106.default.createElement(typography_default.Text, { ...r }, e2), "TextField");
var Un = o2(({ value: e2, ...r }) => import_react107.default.createElement(tag_default, { ...r }, e2 == null ? void 0 : e2.toString()), "TagField");
var Hn = o2(({ value: e2, ...r }) => import_react108.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...r }, e2), "EmailField");
var Qn = o2(({ value: e2, imageTitle: r, ...t }) => import_react109.default.createElement(image_default, { ...t, src: e2, title: r }), "ImageField");
var qn = o2(({ value: e2, valueLabelTrue: r = "true", valueLabelFalse: t = "false", trueIcon: s = import_react110.default.createElement(CheckOutlined_default, null), falseIcon: n2 = import_react110.default.createElement(CloseOutlined_default, null), ...a }) => import_react110.default.createElement(tooltip_default, { title: e2 ? r : t, ...a }, e2 ? import_react110.default.createElement("span", null, s) : import_react110.default.createElement("span", null, n2)), "BooleanField");
var Gn = o2(({ value: e2, locales: r, format: t = "L", ...s }) => {
  import_dayjs5.default.extend(import_localizedFormat.default);
  let n2 = import_dayjs5.default.locale();
  return import_react111.default.createElement(typography_default.Text, { ...s }, e2 ? (0, import_dayjs5.default)(e2).locale(r || n2).format(t) : "");
}, "DateField");
var Yn = o2(({ title: e2, src: r, ...t }) => import_react112.default.createElement(fr, { value: r, title: e2, ...t }, e2 ?? r), "FileField");
var fr = o2(({ children: e2, value: r, ...t }) => import_react113.default.createElement(typography_default.Link, { href: r, ...t }, e2 ?? r), "UrlField");
function ea() {
  return !!(typeof Intl == "object" && Intl && typeof Intl.NumberFormat == "function");
}
o2(ea, "toLocaleStringSupportsOptions");
var ra = o2(({ value: e2, locale: r, options: t, ...s }) => {
  let n2 = Number(e2);
  return import_react114.default.createElement(typography_default.Text, { ...s }, ea() ? n2.toLocaleString(r, t) : n2);
}, "NumberField");
var na = o2(({ value: e2 = "" }) => import_react115.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var la = o2((e2) => {
  let { setSelectedKeys: r, confirm: t, clearFilters: s, mapValue: n2 = o2((f) => f, "mapValue"), selectedKeys: a, children: p } = e2, i = q(), l = o2(() => {
    s && s();
  }, "clearFilter"), u = o2(() => {
    let f;
    typeof a == "number" ? f = `${a}` : import_dayjs6.default.isDayjs(a) ? f = [a.toISOString()] : f = a, r(f), t == null || t();
  }, "onFilter"), y = o2((f) => {
    if (typeof f == "object") {
      if (Array.isArray(f)) {
        let b = n2(f, "onChange");
      ...
      let c = !f || !f.target || import_dayjs6.default.isDayjs(f) ? { target: { value: f } } : f, { target: T } = c, g = n2(T.value, "onChange");
      r(g);
      return;
    }
    let m = n2(f, "onChange");
    r(m);
  }, "onChange"), d = import_react116.default.Children.map(p, (f) => import_react116.default.isValidElement(f) ? import_react116.default.cloneElement(f, { onChange: y, value: n2(a, "value") }) : f);
  return import_react116.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react116.default.createElement("div", { style: { marginBottom: 15 } }, d), import_react116.default.createElement(space_default, null, import_react116.default.createElement(button_default, { type: "primary", size: "small", onClick: () => u() }, import_react116.default.createElement(FilterOutlined_default, null), " ", i("buttons.filter", "Filter")), import_react116.default.createElement(button_default, { danger: true, size: "small", onClick: () => l() }, i("buttons.clear", "Clear"))));
}, "FilterDropdown");
var Fa = o2(() => {
  let [e2, r] = (0, import_react117.useState)(), t = q(), s = pe(), { resource: n2, action: a } = G();
  return (0, import_react117.useEffect)(() => {
    n2 && a && r(t("pages.error.info", { action: a, resource: n2 == null ? void 0 : n2.name }, `You may have forgotten to add the "${a}" component to "${n2 == null ? void 0 : n2.name}" resource.`));
  }, [n2, a]), import_react117.default.createElement(result_default, { status: "404", title: "404", extra: import_react117.default.createElement(space_default, { direction: "vertical", size: "large" }, import_react117.default.createElement(space_default, null, import_react117.default.createElement(typography_default.Text, null, t("pages.error.404", "Sorry, the page you visited does not exist.")), e2 && import_react117.default.createElement(tooltip_default, { title: e2 }, import_react117.default.createElement(InfoCircleOutlined_default, {}))), import_react117.default.createElement(button_default, { type: "primary", onClick: () => s({ to: "/" }) }, t("pages.error.backHome", "Back Home"))) });
}, "ErrorComponent");
var Ca = o2(() => import_react118.default.createElement(xu, null), "WelcomePage");
var Te = {};
var ge = { maxWidth: "400px", margin: "auto", padding: "32px", boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.02), 0px 1px 6px -1px rgba(0, 0, 0, 0.02), 0px 1px 2px rgba(0, 0, 0, 0.03)" };
var Pe = { borderBottom: 0, padding: 0 };
var be = { padding: 0, marginTop: "32px" };
var Fe = { textAlign: "center", marginBottom: 0, fontSize: "24px", lineHeight: "32px", fontWeight: 700, overflowWrap: "break-word", hyphens: "manual", textOverflow: "unset", whiteSpace: "pre-wrap" };
var Tr = o2(({ providers: e2, registerLink: r, forgotPasswordLink: t, rememberMe: s, contentProps: n2, wrapperProps: a, renderContent: p, formProps: i, title: l, hideForm: u, mutationVariables: y }) => {
  let { token: d } = theme_default.useToken(), [f] = form_default.useForm(), m = q(), c = Je(), { mutate: T, isPending: g } = wr(), b = l === false ? null : import_react120.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, l ?? import_react120.default.createElement(oe, { collapsed: false })), S = import_react120.default.createElement(typography_default.Title, { level: 3, style: { color: d.colorPrimaryTextHover, ...Fe } }, m("pages.login.title", "Sign in to your account")), P = o2(() => e2 && e2.length > 0 ? import_react120.default.createElement(import_react120.default.Fragment, null, e2.map((x) => import_react120.default.createElement(button_default, { key: x.name, type: "default", block: true, icon: x.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => T({ ...y, providerName: x.name }) }, x.label)), !u && import_react120.default.createElement(divider_default, null, import_react120.default.createElement(typography_default.Text, { style: { color: d.colorTextLabel } }, m("pages.login.divider", "or")))) : null, "renderProviders"), C = import_react120.default.createElement(card_default, { title: S, styles: { header: Pe, body: be }, style: { ...ge, backgroundColor: d.colorBgElevated }, ...n2 ?? {} }, P(), !u && import_react120.default.createElement(form_default, { layout: "vertical", form: f, onFinish: (x) => T({ ...x, ...y }), requiredMark: false, initialValues: { remember: false }, ...i }, import_react120.default.createElement(form_default.Item, { name: "email", label: m("pages.login.fields.email", "Email"), rules: [{ required: true, message: m("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: m("pages.login.errors.validEmail", "Invalid email address") }] }, import_react120.default.createElement(input_default, { size: "large", placeholder: m("pages.login.fields.email", "Email") })), import_react120.default.createElement(form_default.Item, { name: "password", label: m("pages.login.fields.password", "Password"), rules: [{ required: true, message: m("pages.login.errors.requiredPassword", "Password is required") }] }, import_react120.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react120.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react120.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react120.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, m("pages.login.buttons.rememberMe", "Remember me"))), t ?? import_react120.default.createElement(c, { style: { color: d.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, m("pages.login.buttons.forgotPassword", "Forgot password?"))), !u && import_react120.default.createElement(form_default.Item, null, import_react120.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: g, block: true }, m("pages.login.signin", "Sign in")))), r ?? import_react120.default.createElement("div", { style: { marginTop: u ? 16 : 8 } }, import_react120.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, m("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react120.default.createElement(c, { to: "/register", style: { fontWeight: "bold", color: d.colorPrimaryTextHover } }, m("pages.login.signup", "Sign up")))));
  return import_react120.default.createElement(layout_default, { style: Te, ...a ?? {} }, import_react120.default.createElement(row_default, { justify: "center", align: u ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: u ? "15dvh" : "16px" } }, import_react120.default.createElement(col_default, { xs: 22 }, p ? p(C, b) : import_react120.default.createElement(import_react120.default.Fragment, null, b, C))));
}, "LoginPage");
var gr = o2(({ providers: e2, loginLink: r, wrapperProps: t, contentProps: s, renderContent: n2, formProps: a, title: p, hideForm: i, mutationVariables: l }) => {
  let { token: u } = theme_default.useToken(), [y] = form_default.useForm(), d = q(), f = Je(), { mutate: m, isPending: c } = Ir(), T = p === false ? null : import_react121.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, p ?? import_react121.default.createElement(oe, { collapsed: false })), g = import_react121.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...Fe } }, d("pages.register.title", "Sign up for your account")), b = o2(() => e2 && e2.length > 0 ? import_react121.default.createElement(import_react121.default.Fragment, null, e2.map((P) => import_react121.default.createElement(button_default, { key: P.name, type: "default", block: true, icon: P.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => m({ ...l, providerName: P.name }) }, P.label)), !i && import_react121.default.createElement(divider_default, null, import_react121.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, d("pages.register.divider", d("pages.login.divider", "or"))))) : null, "renderProviders"), S = import_react121.default.createElement(card_default, { title: g, styles: { header: Pe, body: be }, style: { ...ge, backgroundColor: u.colorBgElevated }, ...s ?? {} }, b(), !i && import_react121.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (P) => m({ ...l, ...P }), requiredMark: false, ...a }, import_react121.default.createElement(form_default.Item, { name: "email", label: d("pages.register.email", "Email"), rules: [{ required: true, message: d("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: d("pages.register.errors.validEmail", "Invalid email address") }] }, import_react121.default.createElement(input_default, { size: "large", placeholder: d("pages.register.fields.email", "Email") })), import_react121.default.createElement(form_default.Item, { name: "password", label: d("pages.register.fields.password", "Password"), rules: [{ required: true, message: d("pages.register.errors.requiredPassword", "Password is required") }] }, import_react121.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react121.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, r ?? import_react121.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, d("pages.register.buttons.haveAccount", d("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react121.default.createElement(f, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, d("pages.register.signin", d("pages.login.signin", "Sign in"))))), import_react121.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react121.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: c, block: true }, d("pages.register.buttons.submit", "Sign up")))), i && r !== false && import_react121.default.createElement("div", { style: { marginTop: i ? 16 : 8 } }, import_react121.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, d("pages.register.buttons.haveAccount", d("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react121.default.createElement(f, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, d("pages.register.signin", d("pages.login.signin", "Sign in"))))));
  return import_react121.default.createElement(layout_default, { style: Te, ...t ?? {} }, import_react121.default.createElement(row_default, { justify: "center", align: i ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: i ? "15dvh" : "16px" } }, import_react121.default.createElement(col_default, { xs: 22 }, n2 ? n2(S, T) : import_react121.default.createElement(import_react121.default.Fragment, null, T, S))));
}, "RegisterPage");
var Pr = o2(({ loginLink: e2, wrapperProps: r, contentProps: t, renderContent: s, formProps: n2, title: a, mutationVariables: p }) => {
  let { token: i } = theme_default.useToken(), [l] = form_default.useForm(), u = q(), y = Je(), { mutate: d, isPending: f } = Sr(), m = a === false ? null : import_react122.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react122.default.createElement(oe, { collapsed: false })), c = import_react122.default.createElement(typography_default.Title, { level: 3, style: { color: i.colorPrimaryTextHover, ...Fe } }, u("pages.forgotPassword.title", "Forgot your password?")), T = import_react122.default.createElement(card_default, { title: c, styles: { header: Pe, body: be }, style: { ...ge, backgroundColor: i.colorBgElevated }, ...t ?? {} }, import_react122.default.createElement(form_default, { layout: "vertical", form: l, onFinish: (g) => d({ ...g, ...p }), requiredMark: false, ...n2 }, import_react122.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: u("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react122.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react122.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react122.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.forgotPassword.buttons.haveAccount", u("pages.register.buttons.haveAccount", "Have an account? ")), " ", import_react122.default.createElement(y, { style: { fontWeight: "bold", color: i.colorPrimaryTextHover }, to: "/login" }, u("pages.forgotPassword.signin", u("pages.login.signin", "Sign in"))))), import_react122.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react122.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: f, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react122.default.createElement(layout_default, { style: Te, ...r ?? {} }, import_react122.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react122.default.createElement(col_default, { xs: 22 }, s ? s(T, m) : import_react122.default.createElement(import_react122.default.Fragment, null, m, T))));
}, "ForgotPasswordPage");
var br2 = o2(({ wrapperProps: e2, contentProps: r, renderContent: t, formProps: s, title: n2, mutationVariables: a }) => {
  let { token: p } = theme_default.useToken(), [i] = form_default.useForm(), l = q(), { mutate: u, isPending: y } = Lr(), d = n2 === false ? null : import_react123.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react123.default.createElement(oe, { collapsed: false })), f = import_react123.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Fe } }, l("pages.updatePassword.title", "Set New Password")), m = import_react123.default.createElement(card_default, { title: f, styles: { header: Pe, body: be }, style: { ...ge, backgroundColor: p.colorBgElevated }, ...r ?? {} }, import_react123.default.createElement(form_default, { layout: "vertical", form: i, onFinish: (c) => u({ ...c, ...a }), requiredMark: false, ...s }, import_react123.default.createElement(form_default.Item, { name: "password", label: l("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: l("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react123.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react123.default.createElement(form_default.Item, { name: "confirmPassword", label: l("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: l("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: c }) => ({ validator(T, g) {
    return !g || c("password") === g ? Promise.resolve() : Promise.reject(new Error(l("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  } })] }, import_react123.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react123.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react123.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: y, block: true }, l("pages.updatePassword.buttons.submit", "Update")))));
  return import_react123.default.createElement(layout_default, { style: Te, ...e2 ?? {} }, import_react123.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react123.default.createElement(col_default, { xs: 22 }, t ? t(m, d) : import_react123.default.createElement(import_react123.default.Fragment, null, d, m))));
}, "UpdatePasswordPage");
var pi = o2((e2) => {
  let { type: r } = e2;
  return import_react119.default.createElement(import_react119.default.Fragment, null, o2(() => {
    switch (r) {
      case "register":
        return import_react119.default.createElement(gr, { ...e2 });
      case "forgotPassword":
        return import_react119.default.createElement(Pr, { ...e2 });
      case "updatePassword":
        return import_react119.default.createElement(br2, { ...e2 });
      default:
        return import_react119.default.createElement(Tr, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var fe2 = o2(({ breadcrumbProps: e2, showHome: r = true, hideIcons: t = false, meta: s, minItems: n2 = 2 }) => {
  let { breadcrumbs: a } = YP({ meta: s }), p = Je(), { resources: i } = G(), l = Ro("/", i);
  if (a.length < n2) return null;
  let u = a.map(({ label: d, icon: f, href: m }) => ({ key: `breadcrumb-item-${d}`, title: import_react124.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !t && f, m ? import_react124.default.createElement(p, { to: m }, d) : import_react124.default.createElement("span", null, d)) }));
  return import_react124.default.createElement(breadcrumb_default, { items: o2(() => {
    var d, f;
    return r && l.found ? [{ key: "breadcrumb-item-home", title: import_react124.default.createElement(p, { to: "/" }, ((f = (d = l == null ? void 0 : l.resource) == null ? void 0 : d.meta) == null ? void 0 : f.icon) ?? import_react124.default.createElement(HomeOutlined_default, null)) }, ...u] : u;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var ye = o2(({ children: e2, ...r }) => {
  var i;
  let t = (i = (0, import_react125.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : i.direction, s = o2(() => import_react125.default.createElement(button_default, { type: "text", icon: import_react125.default.createElement(t === "rtl" ? ArrowRightOutlined_default : ArrowLeftOutlined_default, null) }), "renderBackButton"), n2 = typeof r.backIcon > "u" ? s() : r.backIcon, a = typeof r.title == "string" ? import_react125.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, r.title) : r.title, p = typeof r.title == "string" ? import_react125.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, r.subTitle) : r.subTitle;
  return import_react125.default.createElement(PageHeader, { ...r, backIcon: n2, title: a, subTitle: p, style: { padding: 0, ...r.style } }, e2);
}, "PageHeader");
var Gr = o2(({ status: e2, elements: { success: r = import_react126.default.createElement(Ke, { translationKey: "autoSave.success", defaultMessage: "saved", icon: import_react126.default.createElement(CheckCircleOutlined_default, null) }), error: t = import_react126.default.createElement(Ke, { translationKey: "autoSave.error", defaultMessage: "auto save failure", icon: import_react126.default.createElement(ExclamationCircleOutlined_default, null) }), loading: s = import_react126.default.createElement(Ke, { translationKey: "autoSave.loading", defaultMessage: "saving...", icon: import_react126.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react126.default.createElement(Ke, { translationKey: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react126.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react126.default.createElement(Nu, { status: e2, elements: { success: r, error: t, loading: s, idle: n2 } }), "AutoSaveIndicator");
var Ke = o2(({ translationKey: e2, defaultMessage: r, icon: t }) => {
  let s = q(), { token: n2 } = theme_default.useToken();
  return import_react126.default.createElement(typography_default.Text, { style: { marginRight: 5, color: n2.colorTextTertiary, fontSize: ".8rem" } }, s(e2, r), import_react126.default.createElement("span", { style: { marginLeft: ".2rem" } }, t));
}, "Message");
var Ri = o2((e2, r) => e2 && (r === "value" ? e2.map((t) => typeof t == "string" ? (0, import_dayjs7.default)(t) : t) : r === "onChange" && e2.every(import_dayjs7.default.isDayjs) ? e2.map((t) => (0, import_dayjs7.default)(t).toISOString()) : e2), "rangePickerFilterMapper");
var wi = o2((e2) => {
  let { fileList: r } = e2;
  return [...r];
}, "getValueFromEvent");
var Ly = { Blue: { token: { colorPrimary: "#1677FF" } }, Purple: { token: { colorPrimary: "#722ED1" } }, Magenta: { token: { colorPrimary: "#EB2F96" } }, Red: { token: { colorPrimary: "#F5222D" } }, Orange: { token: { colorPrimary: "#FA541C" } }, Yellow: { token: { colorPrimary: "#FAAD14" } }, Green: { token: { colorPrimary: "#52C41A" } } };
export {
  pi as AuthPage,
  Gr as AutoSaveIndicator,
  qn as BooleanField,
  fe2 as Breadcrumb,
  Ms as CloneButton,
  nn as Create,
  ...
  ir as EditButton,
  Hn as EmailField,
  Fa as ErrorComponent,
  Ds as ExportButton,
  Yn as FileField,
  la as FilterDropdown,
  Qn as ImageField,
  Ks as ImportButton,
  _s as List,
  we as ListButton,
  ...
  tr as ThemedHeader,
  Mo as ThemedLayout,
  Ne as ThemedLayoutContext,
  Je2 as ThemedLayoutContextProvider,
  rr2 as ThemedSider,
  oe as ThemedTitle,
  fr as UrlField,
  Ca as WelcomePage,
  It as getDefaultFilter,
  Vt as getDefaultSortOrder,
  wi as getValueFromEvent,
  Ye as mapAntdFilterToCrudFilter,
  $e2 as mapAntdSorterToCrudSorting,
  Ri as rangePickerFilterMapper,
  ul as useCheckboxGroup,
  Er as useDrawer,
  vr as useDrawerForm,
  Gt as useEditableTable,
  Vl as useFileUploadState,
  pe2 as useForm,
  xl2 as useImport,
  Cr as useModal,
  Sr2 as useModalForm,
  ed as useNotificationProvider,
  yl as useRadioGroup,
  il as useSelect,
  io as useSimpleList,
  Rr as useStepsForm,
  Xe as useTable,
  Ur2 as useThemedLayoutContext
};
